...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ViewController = __webpack_require__(3);

	var _ViewController2 = _interopRequireDefault(_ViewController);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var viewController = new _ViewController2.default();

	var playerData = (0, _jQuery2.default)(".charts--player-data");
	var playerPerData = (0, _jQuery2.default)(".charts--player-performance");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ServiceRecord = __webpack_require__(7);

	var _ServiceRecord2 = _interopRequireDefault(_ServiceRecord);

	var _ReturnRecord = __webpack_require__(8);

	var _ReturnRecord2 = _interopRequireDefault(_ReturnRecord);

	var _PlayerStats = __webpack_require__(9);
	...
	var ViewController = function () {
		function ViewController() {
			...
			this.btnGetPlayers = (0, _jQuery2.default)("#GetPlayers");
			this.btnGetPlayerStats = (0, _jQuery2.default)("#GetPlayerStats");
			this.btnDeleteAllPlayers = (0, _jQuery2.default)("#DeleteAllPlayers");
			this.btnDisplayChart = (0, _jQuery2.default)("#DisplayChart");
			this.btnGetNextGenPlayers = (0, _jQuery2.default)("#GetNextGenPlayers");
			this.btnGetNextGenPlayersStats = (0, _jQuery2.default)("#GetNextGenPlayersStats");
			this.btnDeleteNextGenPlayersStats = (0, _jQuery2.default)("#DeleteNextGenPlayersStats");
			this.btnCharts = (0, _jQuery2.default)(".DisplayCharts");
			this.btnRankingCharts = (0, _jQuery2.default)(".RankingCharts");
			this.statsTitle = (0, _jQuery2.default)(".charts--player-performance");
			this.statsRankings = (0, _jQuery2.default)(".rankings");
			this.DataHolder = (0, _jQuery2.default)("#Data");
			this.btnCheckNextGenPlayersData = (0, _jQuery2.default)("#CheckNextGenPlayersData");
			this.btnCheckPlayersData = (0, _jQuery2.default)("#CheckPlayersData");
			this.btnGetPlayerRankings = (0, _jQuery2.default)("#GetPlayerRankings");
			this.btnGetNextGenPlayersRankings = (0, _jQuery2.default)("#GetNextGenPlayersRankings");
			this.Events();
		}
		...
		_createClass(ViewController, [{
			...
			key: 'ShowATPNGData',
			value: function ShowATPNGData(event) {

				event.stopImmediatePropagation();
				var newName = (0, _jQuery2.default)(event.target);
			...
			key: 'GetPlayerStats',
			value: function GetPlayerStats(event) {
				event.preventDefault();
				event.stopPropagation();
			...
			key: 'GetATPPlayerRankings',
			value: function GetATPPlayerRankings(event) {
				event.preventDefault();
				event.stopPropagation();
				this.db = new _Db2.default();
			...
			key: 'GetNGPlayerRankings',
			value: function GetNGPlayerRankings(event) {
				event.preventDefault();
				event.stopPropagation();
				this.db = new _Db2.default();
			...
			key: 'CheckATPPlayersData',
			value: function CheckATPPlayersData(event) {
				event.preventDefault();
				event.stopPropagation();
				this.db = new _Db2.default();
			...
			key: 'CheckNGPlayersData',
			value: function CheckNGPlayersData(event) {
				event.preventDefault();
				event.stopPropagation();
				this.db = new _Db2.default();
			...
			key: 'CheckPlayerData',
			value: function CheckPlayerData(data, mongodb) {
				//console.log(data)
				//console.log(mongodb)


				_jQuery2.default.each(data, function (element, index) {
			...
			key: 'GetNextGenPlayerStats',
			value: function GetNextGenPlayerStats(event) {
				event.preventDefault();
				event.stopPropagation();
				this.db = new _Db2.default();
			...
			key: 'DeleteAllPlayers',
			value: function DeleteAllPlayers(event) {
				event.preventDefault();
				event.stopPropagation();
				this.db = new _Db2.default();
			...
			key: 'DeleteAllNextGenPlayers',
			value: function DeleteAllNextGenPlayers(event) {
				event.preventDefault();
				event.stopPropagation();
				this.db = new _Db2.default();
			...
			key: 'GetPlayers',
			value: function GetPlayers(event) {
				event.preventDefault();
				event.stopPropagation();
				this.db = new _Db2.default();
				this.db.GetPlayers();
			...
			key: 'GetNextGenPlayers',
			value: function GetNextGenPlayers(event) {
				event.preventDefault();
				event.stopPropagation();
				this.db = new _Db2.default();
			...
			key: 'DisplayChart',
			value: function DisplayChart(event) {
				event.preventDefault();
				event.stopPropagation();
				event.stopImmediatePropagation();
				var playerData = (0, _jQuery2.default)(".charts--player-data");
				...
				playerPerData.addClass("charts--hidden");
				var emptyChartArea = (0, _jQuery2.default)(".charts__chart");
				var RecordstoDisplay = (0, _jQuery2.default)("#RecordstoDisplay");
				var noOfPlayers = (0, _jQuery2.default)("#noOfPlayers");
				var chartAction = (0, _jQuery2.default)("#chartAction");

				emptyChartArea.empty();
				this.charts = new _Charts2.default();
				this.charts.Show(chartAction.val(), noOfPlayers.val());
			}
		}, {
			key: 'DisplayRankingChart',
			value: function DisplayRankingChart(event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	_jQuery2.default.ajax = function (_ajax) {
	    ...
	    return function (o) {
	        ...
	        if (/get/i.test(o.type) && !/json/i.test(o.dataType) && isExternal(url)) {
	            ...
	            o.data = {
	                q: query.replace('{URL}', url + (o.data ? (/\?/.test(url) ? '&' : '?') + _jQuery2.default.param(o.data) : '')),
	                format: 'xml'
	            };
...
/***/ function(module, exports) {
	...
	var Player = function Player(id, rank, name, age, points, tournaments, url, urlbreakdown, urlhistory, urlstats, country, stats, rankings) {
		...
		this.age = age;
		this.points = points;
		this.tournamentsplayed = tournaments;
		this.url = url;
		this.urlbreakdown = urlbreakdown;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlayerRankings = __webpack_require__(10);

	var _PlayerRankings2 = _interopRequireDefault(_PlayerRankings);

	var _PlayerRank = __webpack_require__(11);

	var _PlayerRank2 = _interopRequireDefault(_PlayerRank);
	...
	var Db = function () {
		...
		_createClass(Db, [{
			...
			//
			value: function DeleteAllPlayers() {
			...
			key: 'GetRankStats',
			value: function GetRankStats(mongodb, callback) {
			...
			key: 'GetStats',
			value: function GetStats(action, records, mongodb, callback) {
			...
			key: 'GetATPPlayersRankings',
			value: function GetATPPlayersRankings() {
				this.db = new Db();
				var xhr = new XMLHttpRequest();
						...
						_jQuery2.default.each(json, function (index, value) {
							...
							_jQuery2.default.ajax({
								...
								success: function success(res) {
									...
									var prankings = new _PlayerRankings2.default();
									var text = res.responseText;
									var rankTable = (0, _jQuery2.default)(text).find('.mega-table').children('tbody').children('tr').children('td');

									_jQuery2.default.each(rankTable, function (index, value) {
										tempArr.push((0, _jQuery2.default)(rankTable[index]).text().trim());
									});

									for (var i = 0; i < tempArr.length - 1; i++) {
										if (i % 3 === 0) {
											var prank = new _PlayerRank2.default();
			...
			key: 'GetNGPlayersRankings',
			value: function GetNGPlayersRankings() {
				this.db = new Db();
				var xhr = new XMLHttpRequest();
						...
						_jQuery2.default.each(json, function (index, value) {
							_jQuery2.default.ajax({
								...
								success: function success(res) {
									this.DB = new Db();
									var text = res.responseText;
									var rankTable = (0, _jQuery2.default)(text).find('.mega-table').children('tbody').children('tr').find('td');
									var arr = [];
									var arrHolder = [];

									_jQuery2.default.each(rankTable, function (index, value) {
										arr.push((0, _jQuery2.default)(this).text().trim());
									});
									...
									if (arr.length === 0) {
										...
										_jQuery2.default.ajax({ url: delUrl,
											type: "DELETE",
											async: true,
											timeout: 300000,
											success: function success(x) {
									...
									if (arr.length >= 1) {
										...
										var aces, doublefaults, fspercent, fspointswon, sspointswon, bpfaced, bpsaved, gamesplayed, gameswon, totalpointswon;

										var fsreturnpointswon, ssreturnpointswon, bpopportunities, bpconverted, returngamesplayed, returngameswon, returnpointswon, totalpointswon;
										...
										var service = new _ServiceRecord2.default(aces, doublefaults, fspercent, fspointswon, sspointswon, bpfaced, bpsaved, gamesplayed, gameswon, totalpointswon);

										var returns = new _ReturnRecord2.default(fsreturnpointswon, ssreturnpointswon, bpopportunities, bpconverted, returngamesplayed, returngameswon, returnpointswon, totalpointswon);
										var stats = new _PlayerStats2.default(service, returns);
			...
			value: function GetPlayers() {
				...
				_jQuery2.default.ajax({
					...
					success: function success(res) {
						...
						this.DB = new Db();
						var text = res.responseText;
						var rankTable = (0, _jQuery2.default)(text).find('.mega-table').children('tbody').children('tr');

						_jQuery2.default.each(rankTable, function (index, value) {
							var $rank = (0, _jQuery2.default)(this).find('.rank-cell').text().trim();
							var $country = (0, _jQuery2.default)(this).find('.country-item > img').attr('alt');
							var $url = (0, _jQuery2.default)(this).find('.player-cell > a').attr('href');
							var $name = (0, _jQuery2.default)(this).find('.player-cell > a').text();
							var $age = (0, _jQuery2.default)(this).find('.age-cell').text().trim();
							var $points = (0, _jQuery2.default)(this).find('.points-cell').text().trim();
							var $tournaments = (0, _jQuery2.default)(this).find('.tourn-cell').text().trim();
							...
							Db.Post(new _Player2.default(index, $rank, $name, $age, $points, $tournaments, $url, $urlbreakdown, $urlhistory, $urlstats, $country), "atp");
						});
			...
			key: 'GetNextGenPlayers',
			value: function GetNextGenPlayers() {
				...
				_jQuery2.default.ajax({
					...
					success: function success(res) {
						...
						_jQuery2.default.each(rankTable, function (index, value) {
							...
							Db.Post(new _Player2.default(index, $rank, $name, $age, $points, $tournaments, $url, $urlbreakdown, $urlhistory, $urlstats, $country), "next-gen");
						});
						console.log("GET PLAYERS COMPLETED");
					}
				});
			...
			key: 'DeleteAllNextGenPlayers',
			value: function DeleteAllNextGenPlayers() {
			...
			key: 'GetNextGenPlayerStats',
			value: function GetNextGenPlayerStats() {
			...
			key: 'CheckPlayers',
			value: function CheckPlayers(mongodb, callback) {
			...
			value: function APIKEY() {
				...
				var APIKEY = "&apiKey=R8vPnpf4GS1tv93u2Y1ljJaMuzRXo-4M";
				return APIKEY;
			}
		}, {
			key: 'Post',
			value: function Post(obj, mongodb) {
...
/***/ function(module, exports) {
	...
	var ServiceRecord = function ServiceRecord(aces, doublefaults, fspercent, fspointswon, sspointswon, bpfaced, bpsaved, gamesplayed, gameswon, totalpointswon) {
		_classCallCheck(this, ServiceRecord);
...
/***/ function(module, exports) {
	...
	var ReturnRecord = function ReturnRecord(fsreturnpointswon, ssreturnpointswon, bpopportunities, bpconverted, returngamesplayed, returngameswon, returnpointswon, totalpointswon) {
		_classCallCheck(this, ReturnRecord);

		this.fsreturnpointswon = fsreturnpointswon;
		this.ssreturnpointswon = ssreturnpointswon;
		this.bpopportunities = bpopportunities;
		this.bpconverted = bpconverted;
...
/***/ function(module, exports) {
	...
	var PlayerStats = function PlayerStats(servicedata, returndata) {
...
/***/ function(module, exports) {
	...
	var PlayerRankings = function PlayerRankings(rankingdata) {
...
/***/ function(module, exports) {
	...
	var PlayerRank = function PlayerRank(date, singles, doubles) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Charts = function () {
		...
		_createClass(Charts, [{
			key: 'Show',
			value: function Show(action, records) {
				this.db = new _Db2.default();
			...
			key: 'DrawLineChart',
			value: function DrawLineChart(data, mongodb) {
				...
				var chartArea = (0, _jQuery2.default)(".charts__chart");
				var vpWidth = chartArea.outerWidth();
				var vpHeight = chartArea.outerHeight();
				var margin = { top: 20, right: 45, bottom: 100, left: 45 };
				var chartWidth = vpWidth - margin.right * 2;
				var chartHeight = vpHeight - margin.bottom;

				var lineChart = d3.selectAll(chartArea).append("svg").attr("width", chartWidth).attr("height", chartHeight).attr("id", mongodb).append("g").attr("transform", "translate( " + margin.left + "," + margin.top + " ) ");
				...
				d3.json(dataRank, function (error, data) {
					...
					lineChart.append("path").data([data]).attr("class", "line").attr("d", valueline);

					// Add the X Axis
					lineChart.append("g").attr("transform", "translate(0," + chartHeight + ")").call(d3.axisBottom(x));
			...
			key: 'DrawBarChart',
			value: function DrawBarChart(playerStatData, action, mongodb, records) {
				//console.log(action)
				var cfg = new _Config2.default();
				...
				var chartArea = (0, _jQuery2.default)(".charts__chart");
				var chartsPlayerData = (0, _jQuery2.default)(".charts--player-infobox");
				var chartsPlayerPerformanceData = (0, _jQuery2.default)(".charts--player-performance");
				var chartsPlayerPerformanceBox = (0, _jQuery2.default)(".charts--player-performance-box");
				var chartsPlayerPerformanceTitle = (0, _jQuery2.default)(".charts--player-performance-title");

				var vpWidth = chartArea.outerWidth();
				var vpHeight = chartArea.outerHeight();
				var margin = { top: 20, right: 45, bottom: 100, left: 45 };
				var chartWidth = vpWidth - margin.right * 2;
				var chartHeight = vpHeight / 2 - margin.bottom;

				var minScaleX = 0,
				    maxScaleX = records,
				    minScaleY = 0;
				var maxScaleY = void 0,
				    dataMean = void 0,
				    pageTitle = void 0;
				var toolTip = void 0,
				    belowMean = void 0,
				...
				var barChart = d3.selectAll(chartArea).append("svg").attr("width", vpWidth).attr("height", vpHeight / 2).attr("id", mongodb).append("g").attr("transform", "translate( " + margin.left + "," + margin.top + " ) ");
						...
						switch (actionArr[1]) {
							case "aces":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.servicedata.aces / d.stats.servicedata.gamesplayed * 100));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.servicedata.aces / d.stats.servicedata.gamesplayed * 100));
										};
										break;
									case "html":
										return function (d) {
							...
							case "doublefaults":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.servicedata.doublefaults / d.stats.servicedata.gamesplayed * 100));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.servicedata.doublefaults / d.stats.servicedata.gamesplayed * 100));
										};
										break;
									case "html":
										return function (d) {
							...
							case "fspercent":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.servicedata.fspercent));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.servicedata.fspercent));
										};
										break;
									case "html":
										return function (d) {
							...
							case "fspointswon":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.servicedata.fspointswon));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.servicedata.fspointswon));
										};
										break;
									case "html":
										return function (d) {
							...
							case "sspointswon":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.servicedata.sspointswon));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.servicedata.sspointswon));
										};
										break;
									case "html":
										return function (d) {
							...
							case "bpsaved":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.servicedata.bpsaved));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.servicedata.bpsaved));
										};
										break;
									case "html":
										return function (d) {
							...
							case "gameswon":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.servicedata.gameswon));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.servicedata.gameswon));
										};
										break;
									case "html":
										return function (d) {
							...
							case "totalpointswon":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.servicedata.totalpointswon));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.servicedata.totalpointswon));
										};
										break;
									case "html":
										return function (d) {
						...
						switch (actionArr[1]) {
							case "fsreturnpointswon":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.returndata.fsreturnpointswon));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.returndata.fsreturnpointswon));
										};
										break;
									case "html":
										return function (d) {
							...
							case "ssreturnpointswon":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.returndata.ssreturnpointswon));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.returndata.ssreturnpointswon));
										};
										break;
									case "html":
										return function (d) {
							...
							case "bpconverted":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.returndata.bpconverted));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.returndata.bpconverted));
										};
										break;
									case "html":
										return function (d) {
							...
							case "returngameswon":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.returndata.returngameswon));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.returndata.returngameswon));
										};
										break;
									case "html":
										return function (d) {
							...
							case "returnpointswon":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.returndata.returnpointswon));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.returndata.returnpointswon));
										};
										break;
									case "html":
										return function (d) {
							...
							case "totalpointswon":
								switch (attr) {
									case "rect_y":
										return function (d) {
											return yScale(parseInt(d.stats.returndata.totalpointswon));
										};
										break;
									case "rect_h":
										return function (d) {
											return chartHeight - yScale(parseInt(d.stats.returndata.totalpointswon));
										};
										break;
									case "html":
										return function (d) {
				...
				if (actionArr[0] === "servicedata") {
					switch (actionArr[1]) {
						case "aces":
							...
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.aces / d.stats.servicedata.gamesplayed * 100);
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.aces / d.stats.servicedata.gamesplayed * 100);
							});
						...
						case "doublefaults":
							...
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.doublefaults / d.stats.servicedata.gamesplayed * 100);
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.doublefaults / d.stats.servicedata.gamesplayed * 100);
							});
						...
						case "fspercent":
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.fspercent.replace("%", ""));
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.fspercent.replace("%", ""));
							});
						...
						case "fspointswon":
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.fspointswon.replace("%", ""));
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.fspointswon.replace("%", ""));
							});
						...
						case "sspointswon":
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.sspointswon.replace("%", ""));
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.sspointswon.replace("%", ""));
							});
						...
						case "bpsaved":
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.bpsaved.replace("%", ""));
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.bpsaved.replace("%", ""));
							});
						...
						case "gameswon":
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.gameswon.replace("%", ""));
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.gameswon.replace("%", ""));
							});
						...
						case "totalpointswon":
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.totalpointswon.replace("%", ""));
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.servicedata.totalpointswon.replace("%", ""));
							});
					...
					switch (actionArr[1]) {
						case "fsreturnpointswon":
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.returndata.fsreturnpointswon.replace("%", ""));
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.returndata.fsreturnpointswon.replace("%", ""));
							});
						...
						case "ssreturnpointswon":
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.returndata.ssreturnpointswon.replace("%", ""));
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.returndata.ssreturnpointswon.replace("%", ""));
							});
						...
						case "bpconverted":
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.returndata.bpconverted.replace("%", ""));
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.returndata.bpconverted.replace("%", ""));
							});
						...
						case "returngameswon":
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.returndata.returngameswon.replace("%", ""));
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.returndata.returngameswon.replace("%", ""));
							});
						...
						case "returnpointswon":
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.returndata.returnpointswon.replace("%", ""));
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.returndata.returnpointswon.replace("%", ""));
							});
						...
						case "totalpointswon":
							...
							maxScaleY = d3.max(playerStatData, function (d) {
								return parseInt(d.stats.returndata.totalpointswon.replace("%", ""));
							});
							dataMean = d3.mean(playerStatData, function (d) {
								return parseInt(d.stats.returndata.totalpointswon.replace("%", ""));
							});
				...
				var xScale = d3.scaleLinear().domain([minScaleX, maxScaleX]).range([0, chartWidth]).clamp(false);
				var yScale = d3.scaleLinear().domain([minScaleY, maxScaleY]).range([chartHeight, 0]);
				...
				barChart.selectAll("svg").append("g").data(playerStatData).enter().append("rect").on("click", SetAttr(actionArr, "html")).attr("class", function (d) {
					if (d.name === "Akira Santillan") {
						return "akira";
					}return "bar";
				}).attr("x", function (d, i) {
					return i * (chartWidth / playerStatData.length);
				}).attr("y", SetAttr(actionArr, "rect_y")).attr("rx", function () {
					if (playerStatData.length > 50) {
						return 5;
					}
					return 20;
				}).attr("ry", function () {
					...
					return 20;
				}).attr("width", chartWidth / playerStatData.length - 2).attr("height", SetAttr(actionArr, "rect_h")).attr("name", function (d) {
					return d.name;
				...
				barChart.append("g").append("line").style("stroke", "black").style("stroke-width", "2").style("stroke-dasharray", "20,2").style("opacity", .6).attr("x1", 0).attr("y1", yScale(dataMean)).attr("x2", chartWidth).attr("y2", yScale(dataMean)).append("svg:title").text(function () {
					return "Average: " + Math.round(dataMean) + "%";
				});

				barChart.append("g").append("line").style("stroke", function (d) {
					if (actionArr[0] === "servicedata") {
					...
					return "red";
				}).style("stroke-width", "2").style("opacity", .6).style("stroke-dasharray", "20,2").attr("x1", 0).attr("y1", yScale(belowMean)).attr("x2", chartWidth).attr("y2", yScale(belowMean)).append("svg:title").text(function () {
					if (actionArr[0] === "servicedata") {
						if (actionArr[1] === "doublefaults") {
				...
				barChart.append("g").append("line").style("stroke", function (d) {
					...
					return "green";
				}).style("stroke-width", "2").style("opacity", .6).style("stroke-dasharray", "20,2").attr("x1", 0).attr("y1", yScale(aboveMean)).attr("x2", chartWidth).attr("y2", yScale(aboveMean)).append("svg:title").text(function () {
					if (actionArr[0] === "servicedata") {
						if (actionArr[1] === "doublefaults") {
							return "Below Average: " + Math.round(aboveMean) + "%";
						}
				...
				barChart.append("g").append("text").attr("x", chartWidth / 2).attr("y", 0 - 15 / 2).attr("text-anchor", "middle").style("font-size", "16px").style("text-decoration", "underline").text(pageTitle);

				barChart.append("g").append("text").attr("x", chartWidth / 2).attr("y", chartHeight + 32).attr("text-anchor", "middle").style("font-size", "12px").text(" -- Player Rankings -- ");
				...
				barChart.append("g").append("text").attr("transform", "rotate(-90)").attr("x", -chartHeight / 2).attr("y", -30).attr("text-anchor", "middle").style("font-size", "12px").text(" -- Percentage -- ");
			}
		}, {
			key: 'GetPlayersList',
			value: function GetPlayersList(playerStatData, mean, belowMean, aboveMean, type, dataArr) {
				var percent;
				var top = [];
				var above = [];
				var below = [];
				...
				_jQuery2.default.each(playerStatData, function (index, el) {
				...
				if (type === "top") {
					...
					return above.sort(function (a, b) {
						return a[1] - b[1];
					}).reverse();
				} else if (type === "below") {
					return below.sort(function (a, b) {
						return a[1] - b[1];
					});
				} else if (type === "lowest") {
					return lowest.sort(function (a, b) {
						return a[1] - b[1];
					});
				}
			}
		}, {
			key: 'GeneratePerformersHTML',
			value: function GeneratePerformersHTML(arrList, type, mongodb) {
				...
				for (var i = 0; i < arrList.length; i++) {
					...
					if (i < 5) {
						string += "<div class=\"rankings\"><strong>" + (i + 1) + ".</strong>  <a href=\"http://www.atpworldtour.com" + arrList[i][2] + "\" target=\"_blank\" title=\"Click here to view ATP Overview\">" + arrList[i][0] + "</a><strong>  " + arrList[i][1] + "%</strong></div>";
					}
				}
			...
			key: 'GetMeanData',
			value: function GetMeanData(playerStatData, mean, dataArr, belowAbove) {
				var dataMean;
				var percent;
				var arr = [];
				...
				dataMean = d3.mean(arr, function (d) {
					return d;
				});
				return dataMean;
			}
			...
			key: 'GetFirstName',
			value: function GetFirstName(name) {
				var firstName = name.split(" ");
				return firstName[0];
			}
		}, {
			key: 'doWork',
			value: function doWork(playerStatData, action, records, mongodb) {
				var chart = new Charts();
				var objData = [];

				_jQuery2.default.each(playerStatData, function (element, index) {
			...
			key: 'doRankWork',
			value: function doRankWork(playerStatData, mongodb) {
